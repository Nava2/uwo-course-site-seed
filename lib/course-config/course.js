...
class DefaultComponentItem {
  ...
  constructor(props) {
    ...
    /**
     * If true, there is a resource provided
     * @type {boolean}
     */
    this.resourceProvided = props.resourceProvided;
...
class ComponentItem {
  ...
  constructor(parent, index, props) {
    ...
    this.external = (typeof(props.external) != 'undefined') ? props.external : parent.defaults.external;
    this.resourceProvided = (typeof(props.resourceProvided) != 'undefined') ? props.resourceProvided : parent.defaults.resourceProvided;
    this.ext = props.ext || parent.defaults.ext;
